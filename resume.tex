...
\white{\texttt{Hey robot, Here's my skill list. JavaScript angular angularjs react MEAN MERN mongo node express python shell java c++ elasticsearch devops docker kubernetes eks helm ci cd gitlab gtihub actions golang}}
\end{minipage} 
\hfill
